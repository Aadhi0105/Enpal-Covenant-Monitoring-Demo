...
\centering
\small\itshape
Built as an independent technical exploration of AI-assisted covenant monitoring for structured credit facilities. A personal project, not commissioned by any company.
\end{minipage}
...
% ============================================================
\begin{noticebox}
\textbf{Confidentiality Notice.} This project, and this document, are demonstrated entirely on synthetic, self-authored loan agreements and synthetic portfolio data. No real transaction documents belonging to any company or institution are used anywhere in this project. In a production setting, agreement text and portfolio data would be processed entirely within a private environment. Nothing described here reflects, or is derived from, any real deal document.
\end{noticebox}
...
\subsection{The Context: Structured Credit in Growing Asset-Finance Companies}

Consumer asset-finance companies -- particularly in sectors such as residential solar, home equipment, and other point-of-sale financed goods -- commonly follow a similar financing pattern as they scale. Rather than holding all customer financing on their own balance sheet indefinitely, these companies typically sell or pledge pools of customer receivables into special-purpose financing vehicles funded by banks and asset managers: senior and mezzanine warehouse facilities at first, and eventually public asset-backed securitisations, once the underlying portfolio has grown large enough to support one.

A company following this pattern typically starts with a single warehouse relationship and adds new facilities and lenders gradually as its financed portfolio grows -- often at a pace of roughly one new facility relationship a year. Each of these facilities is a real, separately negotiated legal agreement, typically containing financial covenants -- contractual promises about the health of the underlying loan pool or the company's own balance sheet -- that must be tested and reported on every period, for as long as the facility remains outstanding.

\subsection{Why This Is Worth Solving, Even With Few Facilities}

A natural objection: many companies at this stage of growth have only a handful of distinct facility agreements, not hundreds. A handful of documents is not, on its own, a volume problem a small team cannot handle by hand -- so why does this need a system at all?
...
Every document and every figure used anywhere in this project was written specifically for this project. No real transaction document belonging to any company was used, and no real document belonging to any institution was used either, even though such documents are often legally public. Several reasons drove this choice, and they reinforced each other:
